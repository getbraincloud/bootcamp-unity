...
public class Game : MonoBehaviour
{
        ...
        if (m_GameState == GameState.GameOver)
        {
            if (m_EndOfGameDisplayTime > 0.0f)
            {
                ...
                if (m_EndOfGameDisplayTime < 0.0f)
                {
                    ...
                    {
                        //TODO: Implement Leaderboards - replace showing dialog with post score logic
    ...
    public void HandleAuthentication()
    {
        ...
        {
            DialogManager.sharedInstance.ShowUniversalLoginDialog(OnAuthenticationRequestCompleted);
        }
    }
