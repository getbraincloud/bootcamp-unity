...
public class DialogManager : MonoBehaviour
{
    ...
    public void ShowPostScoreDialog(float time, Network.PostScoreRequestCompleted postScoreRequestCompleted = null, Network.PostScoreRequestFailed postScoreRequestFailed = null)
    {
        if (!postScoreDialog.IsShowing())
        {
            postScoreDialog.Set(time, postScoreRequestCompleted, postScoreRequestFailed);
    ...
    public void ShowAttachEmailDialog(Network.AttachEmailIdentityCompleted attachEmailIdentityCompleted = null, Network.AttachEmailIdentityFailed attachEmailIdentityFailed = null)
    {
        if (!attachEmailDialog.IsShowing())
        {
            attachEmailDialog.Set(attachEmailIdentityCompleted, attachEmailIdentityFailed);
