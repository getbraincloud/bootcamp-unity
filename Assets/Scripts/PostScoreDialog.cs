...
public class PostScoreDialog : Dialog
{
    ...
    {
        Network.sharedInstance.PostScoreToLeaderboard(Constants.kBrainCloudMainLeaderboardID, m_Time, inputField.text.ToString(), m_PostScoreRequestCompleted, m_PostScoreRequestFailed);
